...
export function CardStack({ name, icon: Icon }: CardStackProps) {
  return (
    <div className="glass-panel group h-full rounded-[24px] p-5 text-left transition duration-300 hover:-translate-y-1 hover:border-sky-300/30 hover:bg-white/[0.08]">
